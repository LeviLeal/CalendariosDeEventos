...
(function ($) {
    ...
    function createWholeCalendar(settings, $this) {
        ...
        var domSkeleton = '<div class="jqyc" ><div class="jqyc-year-chooser border-bottom row align-items-center" data-current-year="' + year + '">' +
            '<div class="' + colColXs2 + ' text-left">' +
            '   <button type="button" class="btn jqyc-prev-year jqyc-change-year" data-year="' + (year - 1) + '"><</button>' +
            '</div>' +
            ...
            '   <button type="button" class="btn jqyc-next-year jqyc-change-year" data-year="' + (year) + '">></button>' +
            '</div>' +
            '</div>' +
            '<div id="jqyc-months-div" class="jqyc-months">' +
            '<div id="jqyc-month" class="jqyc-month jqyc-jan" data-month="1" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-feb" data-month="2" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-mar" data-month="3" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-apr" data-month="4" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-may" data-month="5" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-jun" data-month="6" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-jul" data-month="7" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-aug" data-month="8" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-sep" data-month="9" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-oct" data-month="10" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-nov" data-month="11" data-year="' + year + '"></div>' +
            '<div id="jqyc-month" class="jqyc-month jqyc-dec" data-month="12" data-year="' + year + '"></div>' +
            '</div></div>';
        if (startFromSunday) {
